    ...
    searchCountry: function searchCountry(event) {
      ...
      setTimeout(function () {
        if (!event.query.trim().length) {
          _this2.filteredCountries = (0,E_laragon_www_back_office_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(_this2.countries);
        } else {
