...
var NodeService = /*#__PURE__*/function () {
  function NodeService() {
    (0,E_laragon_www_back_office_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__.default)(this, NodeService);
  }

  (0,E_laragon_www_back_office_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__.default)(NodeService, [{
    key: "getTreeTableNodes",
    value: function getTreeTableNodes() {
      return axios__WEBPACK_IMPORTED_MODULE_2___default().get('assets/demo/data/treetablenodes.json').then(function (res) {
    ...
    value: function getTreeNodes() {
      return axios__WEBPACK_IMPORTED_MODULE_2___default().get('assets/demo/data/treenodes.json').then(function (res) {
        return res.data.root;
      });
    }
  }]);
